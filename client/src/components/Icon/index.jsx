...
export const DoneIcon = ({ width = '3.2rem', height = '3.2rem' }) => (
    <svg
        viewBox="0 0 80 80"
        focusable="false"
        aria-hidden="true"
    ...
    >
        <path
            fillRule="evenodd"
            d="M74.7 8.7L80 14 23.2 71.3 0 47.9l5.3-5.3 17.9 18L74.7 8.7z"
            fill="currentColor"
        ></path>
    </svg>
);
export const CheckBoxIcon = ({ width = '3.2rem', height = '3.2rem', ...props }) => (
    <svg
        viewBox="0 0 128 128"
        focusable="false"
        aria-hidden="true"
    ...
    >
        <path
            d=" M64,0C28.656,0,0,28.656,0,64s28.656,64,64,64s64-28.656,64-64S99.344,0,64,0z M64,120C33.125,120,8,94.875,8,64 S33.125,8,64,8s56,25.125,56,56S94.875,120,64,120z "
            fillRule="evenodd"
            fill="currentColor"
        ></path>
    </svg>
...
export const Logo = ({ width, height }) => {
    return (
        <svg viewBox="0 0 151 16" width={width} height={height} xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path
