    ...
    <>
      <TableRow sx={{ '& > *': { borderBottom: 'unset' } }}>
        ...
        <TableCell align="center">
          <Label color={paymentInfo.status ? 'success' : 'error'}>{paymentInfo.status ? 'Paid' : 'Unpaid'}</Label>
        </TableCell>
        <TableCell align="left">{totalPrice}</TableCell>
        <TableCell align="left">
          <Label color={orderStatus === 'Placed' ? 'success' : orderStatus === 'Shipped' ? 'success' : 'error'}>
            {orderStatus}
          </Label>
        </TableCell>
